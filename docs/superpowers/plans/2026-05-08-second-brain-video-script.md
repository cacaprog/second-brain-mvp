# Second Brain — Roteiro de Vídeo (Plano de Implementação)

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Escrever o roteiro completo em Português (BR) para um vídeo walkthrough de ~13 minutos sobre o Second Brain MVP, no estilo "Jornada do Criador", didático e empolgante.

**Architecture:** 8 atos narrativos escritos sequencialmente, cada um com objetivo emocional e conteúdo técnico específicos. O roteiro final é um único arquivo Markdown com marcações de cena, falas e notas de produção. A estrutura narrativa usa o Karpathy como ponto de virada dramático no ato 3.

**Tech Stack:** Markdown, dados reais do projeto (26 domínios, 315 páginas wiki, SQLite `db/brain.sqlite`), referência ao gist do Karpathy.

---

## Arquivo de Saída

- **Criar:** `docs/superpowers/scripts/2026-05-08-second-brain-walkthrough-script.md`
- **Spec de referência:** `docs/superpowers/specs/2026-05-08-second-brain-video-script-design.md`

---

## Convenções do Roteiro

Cada ato usa o seguinte formato:

```markdown
## Ato N — [Título] (~X min)

> 🎯 **Objetivo:** [o que o espectador deve sentir/entender ao final deste ato]

[CENA: descrição curta do que aparece na tela]
...
Marcações inline:
- `[CENA: ...]` — o que aparece na tela (terminal, Obsidian, diagrama, etc.)
- `[PAUSA]` — momento de respiração antes de continuar
- `[ÊNFASE]` — palavra ou frase que deve ser dita com destaque

---

## Task 1: Scaffold do arquivo de roteiro

**Files:**
- Create: `docs/superpowers/scripts/2026-05-08-second-brain-walkthrough-script.md`

- [ ] **Step 1: Criar o arquivo com cabeçalho e estrutura dos 8 atos (sem conteúdo)**
...
```bash
ls docs/superpowers/scripts/
```
Esperado: `2026-05-08-second-brain-walkthrough-script.md`

- [ ] **Step 3: Commit**

```bash
git add docs/superpowers/scripts/2026-05-08-second-brain-walkthrough-script.md
git commit -m "docs: scaffold video script file"
```

---

## Task 2: Escrever Ato 1 — Gancho

**Files:**
- Modify: `docs/superpowers/scripts/2026-05-08-second-brain-walkthrough-script.md`

**Objetivo do ato:** fazer o espectador pensar "esse sou eu" antes de qualquer detalhe técnico.

- [ ] **Step 1: Escrever o Ato 1 completo**

Substituir o placeholder `## Ato 1` pelo conteúdo abaixo:
...
- [ ] **Step 2: Verificar tom e objetivo**

Checar: o ato cria identificação emocional sem mencionar nenhum detalhe técnico? Sim → continuar. Não → reescrever o parágrafo que quebra o tom.

- [ ] **Step 3: Commit**

```bash
git add docs/superpowers/scripts/2026-05-08-second-brain-walkthrough-script.md
git commit -m "docs(script): write Act 1 - hook"
```

---

## Task 3: Escrever Ato 2 — A Descoberta

**Files:**
- Modify: `docs/superpowers/scripts/2026-05-08-second-brain-walkthrough-script.md`

**Objetivo do ato:** apresentar o Karpathy e sua ideia com entusiasmo genuíno — criar esperança.

- [ ] **Step 1: Escrever o Ato 2 completo**
...
- [ ] **Step 2: Verificar objetivo**

Checar: o ato explica a diferença RAG vs LLM Wiki de forma acessível (sem pressupor conhecimento técnico)? A empolgação é genuína, não forçada? Sim → continuar.

- [ ] **Step 3: Commit**

```bash
git add docs/superpowers/scripts/2026-05-08-second-brain-walkthrough-script.md
git commit -m "docs(script): write Act 2 - the discovery (Karpathy)"
```

---

## Task 4: Escrever Ato 3 — O Limite da Ideia

**Files:**
- Modify: `docs/superpowers/scripts/2026-05-08-second-brain-walkthrough-script.md`

**Objetivo do ato:** a virada dramática — o espectador entende por que a ideia do Karpathy quebra especificamente no caso de quem tem muitas notas.

- [ ] **Step 1: Escrever o Ato 3 completo**
...
Checar: o espectador entende a diferença entre "erro de fato" e "corrupção estrutural"? A analogia do GPS é clara? O limite está explicado em termos técnicos acessíveis? Sim → continuar.

- [ ] **Step 3: Commit**

```bash
git add docs/superpowers/scripts/2026-05-08-second-brain-walkthrough-script.md
git commit -m "docs(script): write Act 3 - the breaking point"
```

---

## Task 5: Escrever Ato 4 — O Insight Híbrido

**Files:**
- Modify: `docs/superpowers/scripts/2026-05-08-second-brain-walkthrough-script.md`

**Objetivo do ato:** revelar a solução com clareza — três princípios que resolvem o problema de escala.

- [ ] **Step 1: Escrever o Ato 4 completo**
...
Checar: os três princípios estão claros e distintos? As analogias (especialistas por domínio, pré-aprovação de cartão) são acessíveis para público não técnico? Sim → continuar.

- [ ] **Step 3: Commit**

```bash
git add docs/superpowers/scripts/2026-05-08-second-brain-walkthrough-script.md
git commit -m "docs(script): write Act 4 - the hybrid insight"
```

---

## Task 6: Escrever Ato 5 — O Pipeline na Prática

**Files:**
- Modify: `docs/superpowers/scripts/2026-05-08-second-brain-walkthrough-script.md`

**Objetivo do ato:** walkthrough técnico acessível — mostrar como as peças se encaixam sem pressupor conhecimento de programação.

- [ ] **Step 1: Escrever o Ato 5 completo**
...
Checar: cada etapa tem um nome claro e uma função compreensível sem código? O fluxo completo (nota → wiki → query) está coberto? Sim → continuar.

- [ ] **Step 3: Commit**

```bash
git add docs/superpowers/scripts/2026-05-08-second-brain-walkthrough-script.md
git commit -m "docs(script): write Act 5 - pipeline walkthrough"
```

---

## Task 7: Escrever Ato 6 — O Estado Atual

**Files:**
- Modify: `docs/superpowers/scripts/2026-05-08-second-brain-walkthrough-script.md`

**Objetivo do ato:** tornar tangível o que já existe — números reais, não promessas.

- [ ] **Step 1: Escrever o Ato 6 completo**
...
Checar: todos os números citados batem com os dados reais do banco (`26 domínios`, `315 páginas`, `303 committed`, `450 classified`)? Sim → continuar. Se não, corrigir os números.

- [ ] **Step 3: Commit**

```bash
git add docs/superpowers/scripts/2026-05-08-second-brain-walkthrough-script.md
git commit -m "docs(script): write Act 6 - current state"
```

---

## Task 8: Escrever Ato 7 — Como Melhorar

**Files:**
- Modify: `docs/superpowers/scripts/2026-05-08-second-brain-walkthrough-script.md`

**Objetivo do ato:** abrir o horizonte — mostrar que o sistema é uma base, não um produto acabado.

- [ ] **Step 1: Escrever o Ato 7 completo**
...
Checar: as melhorias estão ordenadas do mais imediato para o mais ambicioso? Nenhuma parece vaga ou genérica? Sim → continuar.

- [ ] **Step 3: Commit**

```bash
git add docs/superpowers/scripts/2026-05-08-second-brain-walkthrough-script.md
git commit -m "docs(script): write Act 7 - improvements"
```

---

## Task 9: Escrever Ato 8 — Conclusão + Notas de Produção

**Files:**
- Modify: `docs/superpowers/scripts/2026-05-08-second-brain-walkthrough-script.md`

**Objetivo do ato:** deixar uma ideia clara e duradoura na cabeça do espectador.

- [ ] **Step 1: Escrever o Ato 8 completo**
...
- [ ] **Step 2: Verificar a conclusão**

Checar: a frase "um pensador que lembra" ecoa a frase de fechamento do Ato 1 ("um segundo cérebro que pensasse junto comigo")? Sim → o arco narrativo está fechado.

- [ ] **Step 3: Commit**

```bash
git add docs/superpowers/scripts/2026-05-08-second-brain-walkthrough-script.md
git commit -m "docs(script): write Act 8 - conclusion + production notes"
```

---

## Task 10: Revisão final — fluxo, tom e consistência

**Files:**
- Modify: `docs/superpowers/scripts/2026-05-08-second-brain-walkthrough-script.md`

- [ ] **Step 1: Ler o roteiro completo do início ao fim**

Verificar:
1. O arco narrativo fecha? (Ato 1 abre com o problema, Ato 8 resolve com a filosofia)
2. O Karpathy é tratado com respeito — não como "solução errada" mas como "inspiração com um limite específico"?
3. As analogias são consistentes ao longo do roteiro?
4. Nenhum ato pressupõe conhecimento técnico não explicado nos atos anteriores?
5. O tom é didático e empolgante — nunca árido, nunca condescendente?

- [ ] **Step 2: Verificar consistência dos números**

Números a confirmar no banco de dados:
```bash
sqlite3 db/brain.sqlite "SELECT status, COUNT(*) FROM notes GROUP BY status;"
```
Esperado: `classified|450`, `committed|303`, domínios: 26, páginas wiki: 315

Se os números no roteiro não baterem, corrigir antes de commitar.

- [ ] **Step 3: Commit final**

```bash
git add docs/superpowers/scripts/2026-05-08-second-brain-walkthrough-script.md
git commit -m "docs(script): final review and polish"
```
